...
namespace Trx.Messaging {
	...
	/// </remarks>
	public class BcdBinaryEncoder : IBinaryEncoder {

		private static volatile BcdBinaryEncoder[] _leftPaddedInstance = {
			null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null
		};
		private static volatile BcdBinaryEncoder[] _rightPaddedInstance = {
			null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null
		};
		...
		/// </param>
		private BcdBinaryEncoder( bool leftPadded, byte pad) {
		...
		/// </param>
		/// <returns>
		/// An instance of <see cref="BcdBinaryEncoder"/>.
		/// </returns>
		public static BcdBinaryEncoder GetInstance( bool leftPadded, byte pad) {

			if ( ( pad < 0) || ( pad > 15)) {
				throw new ArgumentOutOfRangeException( "pad", pad, SR.InvalidPad);
			}

			BcdBinaryEncoder[] instances;

			if ( leftPadded) {
				instances = _leftPaddedInstance;
			} else {
				instances = _rightPaddedInstance;
			}

			if ( instances[pad] == null) {
				lock ( typeof( BcdBinaryEncoder)) {
					if ( instances[pad] == null) {
						instances[pad] = new BcdBinaryEncoder( leftPadded, pad);
					}
				}
			}
