...
namespace Trx.Messaging.Iso8583 {
	...
	public class Iso8583Bin1987MessageFormatter : Iso8583MessageFormatter {
        ...
        /// </summary>
        public Iso8583Bin1987MessageFormatter() : base() {
        ...
        private void SetupFields() {
            ...
            FieldFormatters.Add( new StringFieldFormatter(               3, new FixedLengthManager( 6 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(11, new FixedLengthManager( 6 ), BcdStringEncoder.GetInstance( true, 0 ), ZeroPaddingLeft.GetInstance( false, false ), "Systems trace audit number" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                12, new FixedLengthManager( 6 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                15, new FixedLengthManager( 4 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                22, new FixedLengthManager( 3 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                25, new FixedLengthManager( 2 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, false ), "Point of service condition code" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                26, new FixedLengthManager( 2 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                28, new FixedLengthManager( 9 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Transaction fee amount" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                29, new FixedLengthManager( 9 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Settlement fee amount" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                30, new FixedLengthManager( 9 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Transaction processing fee amount" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                31, new FixedLengthManager( 9 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                53, new FixedLengthManager( 16 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                66, new FixedLengthManager( 1 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                71, new FixedLengthManager( 4 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Message number" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                72, new FixedLengthManager( 4 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                82, new FixedLengthManager( 12 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Credits, processing fee amount" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                83, new FixedLengthManager( 12 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Credits, transaction fee amount" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                84, new FixedLengthManager( 12 ), BcdStringEncoder.GetInstance( true, 0 ),
                ZeroPaddingLeft.GetInstance( false, true ), "Debits, processing fee amount" ) );
            FieldFormatters.Add( new StringFieldFormatter(
                85, new FixedLengthManager( 12 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                90, new FixedLengthManager( 42 ), BcdStringEncoder.GetInstance( true, 0 ),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                ...
                "Replacement amounts" ) );
            FieldFormatters.Add( new BinaryFieldFormatter(
                96, new FixedLengthManager( 16 ), BinaryEncoder.GetInstance(),
        ...
        public override object Clone() {
			...
			Iso8583Bin1987MessageFormatter formatter = new Iso8583Bin1987MessageFormatter();
