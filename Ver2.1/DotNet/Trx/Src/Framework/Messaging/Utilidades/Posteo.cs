    ...
    class Posteo
    {
        ...
        private void ejecucionPosteo() 
        {
            try
            {
                ...
                //if (this._iGrabaMsg == 1) UTILIDADES.mensaje("DEBUGP: " + "Optiene "+ files.GetLongLength +" Archivos de Posteo", "LogEvent", "log"); 
                ...
                UTILIDADES.mensaje("DEBUGP: " + "Finalizo Posteo", "LogEvent", "log"); 
            }
            catch (Exception e)
            {
                if (this._iGrabaMsg == 1) UTILIDADES.mensaje("POSTEO: " + e.Message, "LogEvent", "log");
