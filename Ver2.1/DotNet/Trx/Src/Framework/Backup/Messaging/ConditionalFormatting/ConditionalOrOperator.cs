...
namespace Trx.Messaging.ConditionalFormatting {
	...
	/// </summary>
	[Serializable]
	public class ConditionalOrOperator : IBooleanExpression {
        ...
        /// </param>
        public ConditionalOrOperator( IBooleanExpression leftExpression, IBooleanExpression rightExpression ) {
