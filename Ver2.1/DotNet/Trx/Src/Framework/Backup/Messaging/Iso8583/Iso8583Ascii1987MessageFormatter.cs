...
namespace Trx.Messaging.Iso8583 {
	...
	public class Iso8583Ascii1987MessageFormatter : Iso8583MessageFormatter {
		...
		/// </summary>
		public Iso8583Ascii1987MessageFormatter() : base() {
        ...
        private void SetupFields() {
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                44, new VariableLengthManager( 0, 25, StringLengthEncoder.GetInstance( 25 ) ),
            ...
            FieldFormatters.Add( new BinaryFieldFormatter(
                52, new FixedLengthManager( 8 ), HexadecimalBinaryEncoder.GetInstance(),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                ...
                StringEncoder.GetInstance(), "Reserved for private use" ) );
            FieldFormatters.Add( new BinaryFieldFormatter(
                64, new FixedLengthManager( 8 ), HexadecimalBinaryEncoder.GetInstance(),
            ...
            FieldFormatters.Add( new StringFieldFormatter(
                ...
                StringEncoder.GetInstance(), "Reserved for private use" ) );
            FieldFormatters.Add( new BinaryFieldFormatter(
                128, new FixedLengthManager( 8 ), HexadecimalBinaryEncoder.GetInstance(),
