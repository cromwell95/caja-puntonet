...
namespace Trx.Messaging.Channels {
	...
	/// </para>
	/// </remarks>
	public abstract class FilterSkeleton : IMessageFilter {
		...
		/// </remarks>
		private IMessageFilter next = null;
		...
		/// </para>
		/// </remarks>
		abstract public MessageFilterDecision Decide( IChannel channel, Message message);
