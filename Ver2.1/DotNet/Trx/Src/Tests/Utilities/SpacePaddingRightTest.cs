...
namespace Trx.Tests.Utilities {
	...
	public class SpacePaddingRightTest {
		...
		private SpacePaddingRight _paddingWithTruncate = null;
		private SpacePaddingRight _paddingWithoutTruncate = null;

		#region Constructors
		/// <summary>
		/// It builds and initializes a new instance of the class
		/// <see cref="SpacePaddingRightTest"/>.
		/// </summary>
		public SpacePaddingRightTest() {
