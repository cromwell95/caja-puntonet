...
namespace Trx.Tests.Utilities {
	...
	/// <summary>
	/// Test fixture for ZeroPaddingRight.
	/// </summary>
	[TestFixture( Description="Zero padding right tests.")]
	public class ZeroPaddingRightTest {

		private ZeroPaddingRight _paddingWithTruncate = null;
		private ZeroPaddingRight _paddingWithoutTruncate = null;

		#region Constructors
		/// <summary>
		/// It builds and initializes a new instance of the class
		/// <see cref="ZeroPaddingRightTest"/>.
		/// </summary>
		public ZeroPaddingRightTest() {
		...
		public void SetUp() {
			...
			_paddingWithTruncate = ZeroPaddingRight.GetInstance( true, true);
			Assert.IsNotNull( _paddingWithTruncate);

			_paddingWithoutTruncate = ZeroPaddingRight.GetInstance( false, true);
		...
		public void GetInstance() {
			...
			Assert.IsTrue( _paddingWithTruncate == ZeroPaddingRight.GetInstance( true, true));
			Assert.IsTrue( _paddingWithoutTruncate == ZeroPaddingRight.GetInstance( false, true));
		}
		...
		public void Pad() {
			...
			string paddedData = "Test data00000000000";
			string result;
		...
		public void RemovePad() {
			...
			string paddedData = "My test data00000000";
			string result;
