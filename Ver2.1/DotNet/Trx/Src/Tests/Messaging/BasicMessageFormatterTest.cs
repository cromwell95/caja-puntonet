...
namespace Trx.Tests.Messaging {
	...
	public class BasicMessageFormatterTest : BasicMessageFormatterBaseTest {
		...
		private FieldFormatter[] _fixedMessageFormatter = {
			...
			new StringFieldFormatter( 2, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new StringFieldFormatter( 3, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new StringFieldFormatter( 4, new FixedLengthManager( 8), StringEncoder.GetInstance()),
			new StringFieldFormatter( 5, new FixedLengthManager( 15), StringEncoder.GetInstance()),
			new StringFieldFormatter( 6, new FixedLengthManager( 20), StringEncoder.GetInstance(),
		...
		private MessageFormatterTestConfig[] _fixedMessageFormatterTests = {
				...
				new MessageFormatterTestConfig(
					...
					new StringMessageHeaderFormatter( new VariableLengthManager( 1, 10,
						StringLengthEncoder.GetInstance( 10)), StringEncoder.GetInstance()),
					new StringMessageHeader( "HEADER"),
		...
		private FieldFormatter[] _bitmappedMessageFormatter = {
			new BitMapFieldFormatter( 0, 1, 32, HexadecimalBinaryEncoder.GetInstance()),
			new StringFieldFormatter( 1, new FixedLengthManager( 2), StringEncoder.GetInstance()),
			new StringFieldFormatter( 2, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new StringFieldFormatter( 3, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new StringFieldFormatter( 4, new FixedLengthManager( 8), StringEncoder.GetInstance()),
			...
			new StringFieldFormatter( 20, new VariableLengthManager( 0, 999,
				StringLengthEncoder.GetInstance( 999)), StringEncoder.GetInstance()),
			null, null, null, null, null, null, null, null, null, null,
			new StringFieldFormatter( 31, new VariableLengthManager( 0, 9,
				StringLengthEncoder.GetInstance( 9)), StringEncoder.GetInstance(),
				SpacePaddingRight.GetInstance( false), string.Empty),
			new BitMapFieldFormatter( 32, 33, 40, HexadecimalBinaryEncoder.GetInstance()),
			null, null,
			new StringFieldFormatter( 35, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			null, null, null,
			new StringFieldFormatter( 39, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new BitMapFieldFormatter( 40, 41, 48, HexadecimalBinaryEncoder.GetInstance()),
			new StringFieldFormatter( 42, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			null, null, null, null, null,
			new StringFieldFormatter( 47, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			null};
		private MessageFormatterTestConfig[] _bitmappedMessageFormatterTests = {
				...
				new MessageFormatterTestConfig(
					...
					new StringMessageHeaderFormatter( new FixedLengthManager( 15),
						StringEncoder.GetInstance(), SpacePaddingLeft.GetInstance( true)),
		...
		private FieldFormatter[] _mixedMessageFormatter = {
			...
			new StringFieldFormatter( 2, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new StringFieldFormatter( 3, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new BitMapFieldFormatter( 4, 5, 32, HexadecimalBinaryEncoder.GetInstance()),
			new StringFieldFormatter( 5, new FixedLengthManager( 15), StringEncoder.GetInstance()),
			new StringFieldFormatter( 6, new FixedLengthManager( 20), StringEncoder.GetInstance(),
				SpacePaddingLeft.GetInstance( false), string.Empty),
			null, null, null, null, null, null, null, null,
		...
		private FieldFormatter[] _mixedExtendedMessageFormatter = {
			...
			new StringFieldFormatter( 2, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new StringFieldFormatter( 3, new FixedLengthManager( 4), StringEncoder.GetInstance()),
			new BitMapFieldFormatter( 4, 5, 20, HexadecimalBinaryEncoder.GetInstance()),
			new StringFieldFormatter( 5, new FixedLengthManager( 15), StringEncoder.GetInstance()),
			new StringFieldFormatter( 6, new FixedLengthManager( 20), StringEncoder.GetInstance(),
				SpacePaddingLeft.GetInstance( false), string.Empty),
			null, null, null, null, null, null, null, null,
			...
			new StringFieldFormatter( 20, new VariableLengthManager( 0, 999,
				StringLengthEncoder.GetInstance( 999)), StringEncoder.GetInstance()),
			null, null, null, null, null, null, null, null, null, null,
			new StringFieldFormatter( 31, new FixedLengthManager( 10), StringEncoder.GetInstance()),
			new StringFieldFormatter( 32, new FixedLengthManager( 12), StringEncoder.GetInstance(),
				SpacePaddingLeft.GetInstance( false), string.Empty),
		};
