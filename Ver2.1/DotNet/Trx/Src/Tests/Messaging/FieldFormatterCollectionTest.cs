...
namespace Trx.Tests.Messaging {
	...
	public class FieldFormatterCollectionTest {
		...
		private FieldFormatter[] _fieldFormatters = {
			new StringFieldFormatter( 0, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 48, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 25, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 3, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 11, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 64, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 1, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 12, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 2, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 49, new FixedLengthManager( 1), StringEncoder.GetInstance()),
			new StringFieldFormatter( 4, new FixedLengthManager( 1), StringEncoder.GetInstance())};
